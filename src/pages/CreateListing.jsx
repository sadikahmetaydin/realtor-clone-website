...
export default function CreateListing() {
  ...
  const { type, name, bedrooms, bathrooms, parking, furnished, address, desciption, offer, regularPrice, discountedPrice } = formData;
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form>
        ...
        <textarea type="text" id="adress" value={address} onChange={onChange} placeholder="Address" required
          className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6" />
