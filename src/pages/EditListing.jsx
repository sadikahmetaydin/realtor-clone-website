...
export default function EditListing() {
  ...
  const { type, name, bedrooms, bathrooms, parking, furnished, address, desciption, offer, regularPrice, discountedPrice, latitude, longitude, images } = formData;
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
        ...
        <textarea type="text" id="desciption" value={desciption} onChange={onChange} placeholder="Desciption" required
          className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6" />
        ...
        {offer && (
          <div className="flex items-center mb-6">
            <div className="">
              <p className="text-lg font-semibold">Dicounted Price</p>
        ...
        <button className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" type="submit">Edit Listing</button>
      </form>
    </main>
  )
}
